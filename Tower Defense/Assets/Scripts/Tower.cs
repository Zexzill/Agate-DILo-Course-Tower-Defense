...
public class Tower : MonoBehaviour
{
    ...
    [SerializeField] private float _shootDistance = 1;
    [SerializeField] private float _shootDelay = 5;
    [SerializeField] private float _bulletSpeed = 1;
    [SerializeField] private float _bulletSplashRadius = 0;
    ...
    public void ShootTarget()
    {
        ...
        {
            bool headHasAimed = Mathf.Abs(_towerHead.transform.rotation.eulerAngles.z - _targetRotation.eulerAngles.z) < 10;
            if(!headHasAimed)
            {
                return;
            }
    ...
    public void SeekTarget()
    {
        ...
        _targetRotation = Quaternion.Euler(new Vector3(0, 0, targetAngle - 90f));

        _towerHead.transform.rotation = Quaternion.RotateTowards(_towerHead.transform.rotation, _targetRotation, Time.deltaTime * 180);
    }
