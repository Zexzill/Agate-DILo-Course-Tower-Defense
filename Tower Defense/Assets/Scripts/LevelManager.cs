...
public class LevelManager : MonoBehaviour
{
    ...
    [SerializeField] List<Enemy> _spawnedEnemies = new List<Enemy>();
    ...
    private void Update()
    {
        ...
        foreach (Enemy enemy in _spawnedEnemies)
        {
            ...
            if(Vector2.Distance(enemy.transform.position, enemy.TargetPosition) < .1f)
            {
    ...
    private void InstantiateAllTowerUI()
    {
        ...
        {
            GameObject newTowerObj = Instantiate(_towerUIPrefab, _towerUIParent);
